...
function ctrCounter(xk, nonce, src, dst) {
    (0, utils_js_1.ensureBytes)(nonce, BLOCK_SIZE);
    (0, utils_js_1.ensureBytes)(src);
...
function ctr32(xk, isLE, nonce, src, dst) {
    ...
    const c32 = (0, utils_js_1.u32)(ctr);
    const view = (0, utils_js_2.createView)(ctr);
    const src32 = (0, utils_js_1.u32)(src);
    const dst32 = (0, utils_js_1.u32)(dst);
...
exports.cbc = (0, utils_js_1.wrapCipher)({ blockSize: 16, nonceLength: 16 }, function cbc(key, iv, opts = {}) {
    (0, utils_js_1.ensureBytes)(key);
    (0, utils_js_1.ensureBytes)(iv, 16);
    const pcks5 = !opts.disablePadding;
    return {
        encrypt: (plaintext, dst) => {
            const xk = expandKeyLE(key);
...
function computeTag(fn, isLE, key, data, AAD) {
    ...
    const view = (0, utils_js_2.createView)(num);
    if (AAD)
        (0, utils_js_2.setBigUint64)(view, 0, BigInt(AAD.length * 8), isLE);
    (0, utils_js_2.setBigUint64)(view, 8, BigInt(data.length * 8), isLE);
    h.update(num);
    return h.digest();
}
/**
...
exports.gcm = (0, utils_js_1.wrapCipher)({ blockSize: 16, nonceLength: 12, tagLength: 16 }, function gcm(key, nonce, AAD) {
    ...
    function deriveKeys() {
        ...
        if (nonce.length === 12) {
            ...
            const view = (0, utils_js_2.createView)(nonceLen);
            (0, utils_js_2.setBigUint64)(view, 8, BigInt(nonce.length * 8), false);
...
function encryptBlock(xk, block) {
    (0, utils_js_1.ensureBytes)(block, 16);
    if (!isBytes32(xk))
