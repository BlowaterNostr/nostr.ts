...
// prettier-ignore
import { createView, setBigUint64, wrapCipher, bytesToHex, concatBytes, ensureBytes, equalBytes, hexToNumber, numberToBytesBE, } from './utils.js';
 ...
 */
export const xsalsa20poly1305 = wrapCipher({ blockSize: 64, nonceLength: 24, tagLength: 16 }, function xsalsa20poly1305(key, nonce) {
    ensureBytes(key);
    ensureBytes(nonce);
    return {
        encrypt: (plaintext) => {
