...
Deno.test("Key Handling", async () => {
    ...
    }
    {
        ...
        const pubkey1 = PublicKey.FromString("4191aff8d9b30ce6653a8eb5cb53c18cd0bd9827563783fe56563919a4616d4f")
        console.log(pubkey1)
    ...
    }
    {
        ...
        const pubkey1 = PublicKey.FromString("npub1gxg6l7xekvxwvef6366uk57p3ngtmxp82cmc8ljk2cu3nfrpd48sc67nft")
        console.log(pubkey1)
        const pubkey2 = PublicKey.FromBech32("npub1gxg6l7xekvxwvef6366uk57p3ngtmxp82cmc8ljk2cu3nfrpd48sc67nft")
        console.log(pubkey2)
        assertEquals(pubkey1, pubkey2)  // same
    }
    /////////////////
    ...
    /////////////////
    {
        ...
        const pri2 = PrivateKey.FromString("6a59b5296384f9eebd3afbea52c4b921d8ec3fc9ea8b2f56d31185663bab561d")
    ...
    const signer3: Signer | Error = InMemoryAccountContext.FromString("private key string in either hex or nsec format")
})
